...
class UsersTestsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'max_date' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_bin', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'max_date' => 'Lorem ipsum dolor sit amet',
                'created' => '2020-04-03 00:15:46',
                'modified' => '2020-04-03 00:15:46',
            ],
        ];
        parent::init();
    }
